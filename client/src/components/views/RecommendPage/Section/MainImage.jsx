...
function MainImage({ title, originalTitle, overview, image }) {
  return (
    <section className="main-movie" 
      style={{ position: "relative", width: "100%", height: "500px", background: `url(${image}) no-repeat center center / cover`}}>
      <div>
          <div style={{ position: 'absolute', maxWidth: '500px', color: "#fff", bottom: '2rem', marginLeft: '2rem', padding: "1rem", background: "rgba(0, 0, 0, 0.5)"}} >
            <h2 style={{ color: "#fff", fontWeight: "bold", fontSize: "2rem" }}>🤗 가장 추천하는 영화에요! 🤗</h2>
            <h3 style={{ color: "#fff", fontSize: "1.5rem"}}>{title} ({originalTitle})</h3>
